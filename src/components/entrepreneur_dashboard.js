...
const Entrepreneur_Dashboard= ()=>{
    ...
    useEffect(()=>{
        ...
        try{
            ...
            const res=await axios.get('http://localhost:5000/api/postproblem/entrepreneurdashboard',{
                headers:header
            })
                    ...
                    <div className="col-sm-6">
                        <div className=" px-4 ">
                            ...
                            <div className="d-flex justify-content-between  mt-5 mb-1" >
                                <Link to={`/responses/${problem._id}`}>
                                    <button className="btn btn-success">View Responses</button>
                                </Link>
                                <Link to={`/viewproblem/${problem._id}`}>
        ...
        <div className="return">
            ...
            <div >
                <div className='mt-5 pt-5'>
                    <h1 className="text-center">Your Problems</h1>
                </div>
...
export default Entrepreneur_Dashboard;
